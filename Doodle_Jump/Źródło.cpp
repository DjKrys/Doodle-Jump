	...
	while (app.isOpen())
	{
		...
		if (menu == 2)
		{
			...
			if (!pause)
			{
				...
				plat1.is_touched(y, dy, x);
				plat2.is_touched(y, dy, x);
				plat3.is_touched(y, dy, x);
				plat4.is_touched(y, dy, x);
				plat5.is_touched(y, dy, x);
				plat6.is_touched(y, dy, x);
				plat7.is_touched(y, dy, x);
				plat8.is_touched(y, dy, x);
				plat9.is_touched(y, dy, x);
				plat10.is_touched(y, dy, x);
